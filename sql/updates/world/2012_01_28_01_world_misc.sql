...
-- Le quito EAI
UPDATE `creature_template` SET `RegenHealth`=0,`AIName`='',`ScriptName`='npc_omen' WHERE `entry`=15467;
DELETE FROM `creature_ai_scripts` WHERE `creature_id`=15467;

-- Le pongo flags_extra como en TDB
UPDATE `creature_template` SET `ScriptName`='npc_firework',`AIName`='',`faction_A`=35,`faction_H`=35,`unit_flags`=33555200,`flags_extra`=0 WHERE `entry` IN (15879,15880,15881,15882,15883,15884,15885,15886,15887,15888,15889,15890,15872,15873,15874,15875,15876,15877,15911,15912,15913,15914,15915,15916,15918);
