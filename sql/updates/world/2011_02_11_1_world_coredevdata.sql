...
-- Guids de ZLDB
UPDATE `creature` SET `position_x`=1357.86,`position_y`=1055.26,`position_z`=463.02 WHERE `guid`=86911;
UPDATE `creature` SET `position_x`=1210.38,`position_y`=1118.57,`position_z`=471.41 WHERE `guid`=86906;
...
INSERT INTO `creature_template_addon` (entry,auras) VALUE (28183,'50798');

DELETE FROM `creature_text` WHERE `entry`=27447;
INSERT INTO `creature_text` (entry,groupid,id,TEXT,TYPE,LANGUAGE,sound) VALUES
(27447,0,0,'There will be no mercy!',14,0,13649),
(27447,1,1,'Blast them! Destroy them!',14,0,13650),
(27447,2,2,'%s calls an Azure Ring Captain!',41,0,0),
(27447,3,3,'They are... too strong! Underestimated their... fortitude.',14,0,13655);
