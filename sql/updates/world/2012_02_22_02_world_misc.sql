...
SET @GUID_GO                  := 47486; -- set by ZLDB
SET @GUID_NPC                 := 139207; -- set by ZLDB
...
SET @QUEST2                    := 13006; -- Polishing the Helm
...
-- Quito creature_addon
DELETE FROM `creature_addon` WHERE `guid` BETWEEN @GUID_NPC+0 AND @GUID_NPC+1;
