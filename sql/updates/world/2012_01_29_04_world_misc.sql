...
UPDATE `creature_template` SET `faction_A`=35,`faction_H`=35,`unit_flags`=0,`RegenHealth`=1,`flags_extra`=0 WHERE `entry` IN (33842,33796,33798,33791,33792,33799,33843,33800,33795,33790,33793,33794);
