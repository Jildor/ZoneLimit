...
UPDATE `creature_template` SET `ScriptName` = 'npc_simon_bunny',`unit_flags` = 0,`flags_extra` = 130 WHERE `entry` = @NPC_SIMON_BUNNY;
...
-- Actualizo gobs igual que en TDB
UPDATE `gameobject_template` SET `faction` = 0 WHERE `entry` = 185890;
UPDATE `gameobject_template` SET `flags` = 32 WHERE `entry` = 185944;
UPDATE `gameobject_template` SET `faction` = 114 WHERE `entry` IN (185608,185610,185612,185614,185616,185618,185620,185622,185628,185629,185630,185631,185632,185633,185634,185635,185676,185677,185678,185679,185680,185681,185682,185683,185684,185685,185686,185687,185688,185689,185690,185691,185700,185701,185702,185703,185724,185725,185726,185727,185728,185729,185730,185731,185732,185733,185734,185735,185736,185737,185738,185739,185740,185741,185742,185743,185744,185745,185746,185747,185748,185749,185750,185751,185752,185753,185754,185755,185764,185765,185766,185767,185799,185800,185801,185802);
UPDATE `gameobject_template` SET `faction` = 0,`flags` = 16 WHERE `entry` IN (185894,185604,185605,185606,185607,185640,185641,185642,185643,185792,185793,185794,185795,185816,185817,185818,185819,185844,185846,185847,185776,185777,185778,185779,185845,185663,185660,185661,185662);
...
-- Le añado gossip_menu_option faltante
DELETE FROM `gossip_menu_option` WHERE `menu_id` IN (@GOSSIP_MENU_ID_NORMAL,@GOSSIP_MENU_ID_LARGE);
INSERT INTO `gossip_menu_option` (`menu_id`, `id`, `option_icon`, `option_text`, `option_id`, `npc_option_npcflag`, `action_menu_id`, `action_poi_id`, `box_coded`, `box_money`, `box_text`) VALUES
(@GOSSIP_MENU_ID_NORMAL,0,0,'Insert an Apexis Shard, and begin!',1,1,0,0,0,0,''),
(@GOSSIP_MENU_ID_LARGE,0,0,'Insert 35 Apexis Shards, and begin!',1,1,0,0,0,0,'');
