...
UPDATE `creature_template` SET `unit_flags`=33024,`AIName` = 'SmartAI' WHERE `entry` = 24669;
-- Le quito EventAI
...
UPDATE `creature_template` SET `unit_flags`=32832,`mechanic_immune_mask`=8388624 WHERE `entry` IN (28199,31188);
...
(86574, 28318, 530, 1, 1, 0, 0, -1775.148438, 5548.291992, -12.428190, 4.146070, 300, 0, 0, 1, 0, 0, 0, 0, 0), -- Grand Apothecary Putress
(88686, 29346, 530, 1, 1, 0, 0, 1925, -4123.1899,  43.1780,  4.79965, 300, 0, 0, 1, 0, 0, 0, 0, 0); -- Apothecary Karlov
...
-- eventEntry de ZLDB
UPDATE `game_event` SET `start_time` = '2011-01-01 14:00:00' WHERE `eventEntry`=70;
...
/* No le cambio la descripcion, no es necesario
