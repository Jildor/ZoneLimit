...
-- Dejo de la guid de TDB (no esta ocupada)
SET @CGUID=152277; -- Need 3
-- Spawns de TDB (Guid ZLDB)
DELETE FROM `gameobject` WHERE `id` IN (194357,194394,195011,300007);
INSERT INTO `gameobject` (`guid`,`id`,`map`,`spawnMask`,`phaseMask`,`position_x`,`position_y`,`position_z`,`orientation`,`rotation0`,`rotation1`,`rotation2`,`rotation3`,`spawntimesecs`,`animprogress`,`state`) VALUES
(16130,194357,571,1,1,8442.67,451.733,596.03,0,0,0,0,1,180,255,1), -- Poison Vial
(16132,194357,571,1,1,9070.32,2050.73,67.2176,0,0,0,0,1,0,0,0), -- Poison Vial
(16133,194357,571,1,1,9073.76,2050.12,68.1572,0,0,0,0,1,0,0,0), -- Poison Vial
(16135,194357,571,1,1,9074.7,2050.71,68.1705,0,0,0,0,1,0,0,0), -- Poison Vial
(16138,194357,571,1,1,9069.59,2050.35,67.2176,0,0,0,0,1,0,0,0), -- Poison Vial
(16139,194357,571,1,1,9069.96,2050.54,67.2176,0,0,0,0,1,0,0,0), -- Poison Vial
(16142,194357,571,1,1,9072.08,2049.29,67.7896,0,0,0,0,1,0,0,0), -- Poison Vial
(16144,194357,571,1,1,9065.68,2052.62,67.2864,0,0,0,0,1,0,0,0), -- Poison Vial
(16146,194394,571,1,1,9083.58,2041.7,67.8181,0,0,0,0,1,0,0,0), -- Cult Rune Circle
(16149,195011,571,1,1,9078.47,2057.55,67.2161,0,0,0,0.998135,0.0610518,0,0,0), -- Bonfire
(16151,300007,571,1,1,8523.51,566.994,552.841,2.1518,0,0,0.880019,0.474938,300,0,1); -- Spell Focus GO?
...
UPDATE `creature_template` SET `unit_flags`=`unit_flags`|8,`dynamicflags`=8,`speed_walk`=6.4,`speed_run`=4,`VehicleId`=368,`InhabitType`=5,`Health_mod`=1,`RegenHealth`=1,`mechanic_immune_mask`=8388624 WHERE `entry`=33519; -- Black Knight''s Gryphon
-- equipment_id de ZLDB
UPDATE `creature_template` SET `faction_A`=2080,`faction_H`=2080,`unit_flags`=`unit_flags`|32768,`equipment_id`=2889 WHERE `entry`=33537; -- Cult Conspirator
