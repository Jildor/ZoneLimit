...
-- correcting vehicles
UPDATE `creature_template` SET `spell1`=50232,`spell2`=50248,`spell3`=50240,`spell4`=50253,`spell5`=0,`spell6`=0 WHERE `entry`=27756;
UPDATE `creature_template` SET `spell1`=49840,`spell2`=49838,`spell3`=49592,`spell4`=0,`spell5`=0,`spell6`=0 WHERE `entry`=27755;
UPDATE `creature_template` SET `spell1`=50328,`spell2`=50341,`spell3`=50344,`spell4`=0,`spell5`=0,`spell6`=0 WHERE `entry`=27692;
UPDATE `creature_template` SET `InhabitType`=5,`speed_run`=1,`speed_walk`=1.2,`RegenHealth`=1 WHERE `entry` IN (27756,27755,27692);

-- eregos texts
DELETE FROM `creature_text` WHERE `entry`=27656;
INSERT INTO `creature_text` (entry,groupid,id,text,type,comment) VALUES
(27656,0,0,'You brash interlopers are out of your element! I will ground you!',14,'Boss Eregos - Aggro'),
(27656,1,0,'Such insolence... such arrogance... must be PUNISHED!',14,'Boss Eregos - Enrage'),
(27656,2,0,'Savor this small victory, foolish little creatures. You and your dragon allies have won this battle. But we will win... the Nexus War.',14,'Boss Eregos - Death');