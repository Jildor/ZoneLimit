-- Editado por Gildor
-- Pongo bien la raza requerida a la quest alianza
UPDATE `quest_template` SET `RequiredRaces`=1101 WHERE `entry`=9879;
-- Kurenai Captive
-- Lo pongo como en TDB
UPDATE `creature_template` SET `faction_A`=1722,`faction_H`=1722,`MovementType`=1,`ScriptName`='npc_kurenai_captive' WHERE `entry`=18209;
