...
UPDATE `creature_template` SET `faction_A`=1701,`faction_H`=1701,`gossip_menu_id`=8336,`AIName`='SmartAI' WHERE `entry`=20563;
-- Lo quito EventAI
DELETE FROM `creature_ai_scripts` WHERE `creature_id`=20563;
