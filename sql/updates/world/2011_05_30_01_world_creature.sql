...
-- Le quito el AIName
-- Saviana Ragefire
UPDATE `creature_template` SET `InhabitType`=3,`mechanic_immune_mask`=`mechanic_immune_mask`|8388624,`AIName` = '',`ScriptName`= 'boss_saviana_ragefire' WHERE `entry`=39747;
