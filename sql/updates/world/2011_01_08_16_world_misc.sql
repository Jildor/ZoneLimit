...
-- faction como en TDB
UPDATE `creature_template` SET `faction_A`=21,`faction_H`=21,`unit_flags`=2 WHERE `entry` IN (29281, 30809); -- And this, fixes her flag so script can be started (credit to ric)
...
-- Borro criteria tipo 18
DELETE FROM `achievement_criteria_data` WHERE `criteria_id`=7322 AND `type` IN (11,18);
...
-- Le pongo inhabittype como en TDB
UPDATE `creature_template` SET `InhabitType`=7 WHERE `entry`=27273; -- Flame Brazier
-- Le quito template_addon
DELETE FROM `creature_template_addon` WHERE `entry`=27273; -- Flame Brazier
...
UPDATE `creature_template` SET `faction_A`=21,`faction_H`=21,`unit_flags`=64,`AIName`='',`mechanic_immune_mask`=8388624,`ScriptName`='npc_scourge_hulk' WHERE `entry`=26555;  -- Scourge Hulk
UPDATE `creature_template` SET `faction_A`=21,`faction_H`=21,`unit_flags`=64,`AIName`='',`mechanic_immune_mask`=8388624 WHERE `entry`=30806;  -- Scourge Hulk H
UPDATE `creature_template` SET `faction_A`=21,`faction_H`=21,`unit_flags`=64,`mechanic_immune_mask`=8388624,`ScriptName`='' WHERE `entry` IN (26668,30810); -- "boss_svala_sorrowgrave" script is now merged with "boss_svala" script
UPDATE `creature_template` SET `faction_A`=1885,`faction_H`=1885,`unit_flags`=256,`ScriptName`='npc_spectator' WHERE `entry`=26667; -- Spectators escape script
UPDATE `creature_template` SET `faction_A`=1885,`faction_H`=1885,`unit_flags`=256 WHERE `entry`=30767; -- Spectators escape script H
UPDATE `creature_template` SET `faction_A`=16,`faction_H`=16,`unit_flags`=32768,`AIName`='',`mechanic_immune_mask`=8388624,`ScriptName`='npc_ritual_channeler' WHERE `entry`=27281; -- Change 'mob_ritual_channeler' to 'npc_ritual_channeler'
UPDATE `creature_template` SET `faction_A`=16,`faction_H`=16,`unit_flags`=32768,`AIName`='',`mechanic_immune_mask`=8388624 WHERE `entry`=30804; -- Change 'mob_ritual_channeler' to 'npc_ritual_channeler' H

-- Le quito template_addon
DELETE FROM `creature_template_addon` WHERE `entry`=26668; -- boss_svala_sorrowgrave
-- Le quito EAI
DELETE FROM `creature_ai_scripts` WHERE `creature_id`=27281; -- npc_ritual_channeler
