...
UPDATE `creature_template` SET `gossip_menu_id`=@GOSSIPID,`faction_A`=1602,`faction_H`=1602,`unit_flags`=0,`dynamicflags`=40 WHERE `entry`=@ENTRY;
-- Le pongo creature_template_addon como en TDB
