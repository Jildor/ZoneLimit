...
UPDATE `creature_template` SET `npcflag`=`npcflag`|1,`unit_flags`=537166592,`dynamicflags`=40,`flags_extra`=0 WHERE `entry` IN (@ENTRY_GUARD, @ENTRY_WORKER);
-- template_addon como en TDB
DELETE FROM `creature_template_addon` WHERE `entry` IN (@ENTRY_GUARD, @ENTRY_WORKER);
INSERT INTO `creature_template_addon` (`entry`,`path_id`,`mount`,`bytes1`,`bytes2`,`emote`,`auras`) VALUES
(@ENTRY_GUARD,0,0,0,1,0,'43167 29266 45459'),
(@ENTRY_WORKER,0,0,0,1,0,'43167 29266 45460');
