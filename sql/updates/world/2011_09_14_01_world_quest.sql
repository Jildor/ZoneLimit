...
(88387,29563,571,1,1,0,0,7335.381,-2055.097,764.3585,3.368485,120,0,0,1,0,0,0,0,0);
-- Le quito creature_addon
...
UPDATE `creature_template` SET `AIName`='SmartAI',`faction_A`=35,`faction_H`=35,`minlevel`=80,`maxlevel`=80,`speed_walk`=1,`speed_run`=2,`unit_flags`=16777216,`VehicleId`=316,`RegenHealth`=1 WHERE `entry`=@ENTRY;
-- Le quito EventAI
...
-- Phasing Spell
-- Borro spell_area de otras areas
DELETE FROM `spell_area` WHERE `spell`=55857 AND `area` IN (4438,4439,4455,4495);
