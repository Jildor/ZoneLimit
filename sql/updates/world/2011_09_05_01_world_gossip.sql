...
UPDATE `creature_template` SET `gossip_menu_id`=9691,`faction_A`=2104,`faction_H`=2104,`AIName`='',`mechanic_immune_mask`=8388624 WHERE `entry`=28471; -- Lady Alistra
...
UPDATE `creature_template` SET `gossip_menu_id`=10027,`unit_flags`=768,`trainer_class`=6 WHERE `entry`=31084;
