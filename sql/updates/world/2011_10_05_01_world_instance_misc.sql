...
UPDATE `creature_template` SET `speed_walk`=2,`speed_run`=1.71429,`exp`=2,`minlevel`=83,`maxlevel`=83,`faction_A`=974,`faction_H`=974,`unit_flags`=768,`dynamicflags`=0,`equipment_id`=3848,`baseattacktime`=1500,`flags_extra`=1 WHERE `entry` IN (36597,39166,39167,39168); -- The Lich King
UPDATE `creature_template` SET `exp`=2,`unit_class`=2,`flags_extra`=0 WHERE `entry`=38995; -- Highlord Tirion Fordring
...
UPDATE `creature_template` SET `speed_walk`=2,`speed_run`=1.42857,`exp`=2,`minlevel`=83,`maxlevel`=83,`faction_A`=14,`faction_H`=14,`dynamicflags`=0,`AIName`='' WHERE `entry` IN (36701,39302,39303,39304); -- Raging Spirit
UPDATE `creature_template` SET `speed_walk`=1.2,`speed_run`=0.428571,`exp`=2,`minlevel`=80,`maxlevel`=80,`faction_A`=14,`faction_H`=14,`dynamicflags`=0,`unit_flags`=33554944,`flags_extra`=0 WHERE `entry`=38757; -- Defile
UPDATE `creature_template` SET `minlevel`=80,`maxlevel`=80,`exp`=2,`faction_A`=14,`faction_H`=14,`speed_walk`=2,`speed_run`=1.71429,`unit_class`=1,`unit_flags`=33554944,`dynamicflags`=0,`VehicleId`=532,`InhabitType`=1|4 WHERE `entry` IN (36609,39120,39121,39122); -- Val'kyr Shadowguard
...
UPDATE `creature_template` SET `speed_walk`=1.2,`speed_run`=0.428571,`exp`=2,`minlevel`=80,`maxlevel`=80,`faction_A`=14,`faction_H`=14,`unit_flags`=33554944,`dynamicflags`=0,`InhabitType`=7,`flags_extra`=128 WHERE `entry`=38584; -- Frostmourne Trigger
UPDATE `creature_template` SET `speed_walk`=2.8,`speed_run`=1,`exp`=2,`minlevel`=80,`maxlevel`=80,`faction_A`=14,`faction_H`=14,`unit_class`=1,`unit_flags`=32832,`dynamicflags`=0,`flags_extra`=256,`InhabitType`=1|4,`mechanic_immune_mask`=8388624 WHERE `entry` IN (37799,39284,39285,39286); -- Vile Spirit
UPDATE `creature_template` SET `speed_walk`=1,`speed_run`=1,`exp`=2,`minlevel`=80,`maxlevel`=80,`faction_A`=1665,`faction_H`=1665,`unit_flags`=32832,`dynamicflags`=0,`flags_extra`=0,`equipment_id`=4229 WHERE `entry` IN (36823,38579,39217); -- Terenas Menethil
...
UPDATE `creature_template` SET `speed_walk`=2.8,`speed_run`=1,`exp`=2,`minlevel`=80,`maxlevel`=80,`faction_A`=14,`faction_H`=14,`unit_flags`=32832,`dynamicflags`=0,`flags_extra`=256,`InhabitType`=1|4,`mechanic_immune_mask`=8388624 WHERE `entry` IN (39190,39287,39288,39289); -- Wicked Spirit
...
DELETE FROM `creature_ai_scripts` WHERE `creature_id`=36824; -- Spirit Warden

-- Creo equip_template de TDB (Entry ZLDB)
DELETE FROM `creature_equip_template` WHERE `entry`=4229;
...
UPDATE `creature_model_info` SET `combat_reach`=3,`gender`=0 WHERE `modelid`=31286; -- Highlord Tirion Fordring

-- Guid de YTDB
DELETE FROM `creature` WHERE `guid`=49049;
-- Pongo el spawn como en TDB (Guid YTDB)
DELETE FROM `creature` WHERE `id` IN (36597,38995);
...
(115782,1,'72846 73220 73878'); -- The Lich King

-- Quito template_addon
DELETE FROM `creature_template_addon` WHERE `entry`=36597; -- The Lich King
DELETE FROM `creature_template_addon` WHERE `entry`=36633; -- Ice Sphere
DELETE FROM `creature_template_addon` WHERE `entry`=36701; -- Raging Spirit
...
DELETE FROM `gameobject` WHERE `id` IN (202078,202161,202437,202141,202142,202143,202144,202190,202436);
...
-- Los pongo como en TDB
UPDATE `gameobject_template` SET `faction`=1375 WHERE `entry`=202436;
