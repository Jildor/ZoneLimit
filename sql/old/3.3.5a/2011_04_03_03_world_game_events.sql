...
-- eventEntry editada para CTDB (64 en TDB, le he puesto 70 que no esta ocupado)
DELETE FROM `game_event` WHERE `eventEntry` IN (@Event,70);
...
(70, '2011-01-03 14:00:00', '2020-12-31 05:00:00',10080,1*60,0, 'Kalu''ak Fishing Derby Fishing Pools',0); -- to be used with conditions
