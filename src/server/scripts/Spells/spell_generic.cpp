    ...
    public:
        ...
        class spell_gen_turkey_tracker_SpellScript : public SpellScript
        {
            ...
            void HandleScript(SpellEffIndex /*effIndex*/)
            {
                ...
                if (Aura* aura = GetTarget()->ToPlayer()->GetAura(GetSpellInfo()->Id))
                {
                    switch (aura->GetStackAmount())
                    {
                        case 10:
                            // To-Do: Missing Emote...
                            GetTarget()->ToPlayer()->CastSpell(target, SPELL_KILL_COUNTER_VISUAL, true, NULL);
                            break;
                        case 20:
                            // To-Do: Missing Emote...
                            GetTarget()->ToPlayer()->CastSpell(target, SPELL_KILL_COUNTER_VISUAL, true, NULL);
                        ...
                        case 40:
                            // To-Do: Missing Emote...
                            GetTarget()->ToPlayer()->CastSpell(target, SPELL_KILL_COUNTER_VISUAL, true, NULL);
                            GetTarget()->ToPlayer()->CastSpell(target, SPELL_KILL_COUNTER_VISUAL_MAX, true, NULL); // Achievement Credit
                            break;
                        default:
                            break;
                    }
